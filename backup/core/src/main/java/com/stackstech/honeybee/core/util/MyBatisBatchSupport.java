...
/**
 * MyBatis中批量处理的操作类 目前只实现了批量插入
 * 由于使用XML来拼接SQL的效率太差 所以使用Java API的方式来解决这个问题
 *
...
public class MyBatisBatchSupport {
    ...
    public static <T> void batchInsertByMapper(SqlSessionFactory sqlSessionFactory, Class<?> mapperClass,
