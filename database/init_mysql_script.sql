...
-- honeybee.hb_dict definition

CREATE TABLE `hb_dict` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `catalog_name` varchar(50) NOT NULL COMMENT '类别',
  `name` varchar(50) NOT NULL COMMENT '字典名称',
  `code` varchar(50) NOT NULL COMMENT '字典代码',
  `dict_order` int(2) NOT NULL COMMENT '序号',
  `status` int(2) NOT NULL COMMENT '状态',
  `owner` bigint(20) NOT NULL COMMENT '操作人',
  `updatetime` datetime NOT NULL COMMENT '记录更新时间',
  `createtime` datetime NOT NULL COMMENT '记录创建时间',
...
INSERT INTO honeybee.hb_dict (catalog_name,name,code,dict_order,status,owner,updatetime,createtime,`desc`) VALUES
	 ('STATUS','删除','-1',1,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',NULL),
	 ('STATUS','启用','0',2,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('STATUS','禁用','1',3,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('SERVICE_STATUS','删除','-1',1,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('SERVICE_STATUS','启用','0',2,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('SERVICE_STATUS','禁用','1',3,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('SERVICE_STATUS','下线','2',4,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('SERVICE_STATUS','上线','3',5,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('AUDIT_TYPE','服务审计','SERVICE',1,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('AUDIT_TYPE','资产审计','ASSETS',2,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0','');
INSERT INTO honeybee.hb_dict (catalog_name,name,code,dict_order,status,owner,updatetime,createtime,`desc`) VALUES
	 ('AUDIT_TYPE','系统审计','SYSTEM',3,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('LOG_TYPE','删除记录','DELETE',1,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('LOG_TYPE','更新记录','UPDATE',2,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('LOG_TYPE','新增记录','INSERT',3,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('LOG_TYPE','用户登录','LOGIN',4,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('LOG_TYPE','用户退出','LOGOUT',5,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('LOG_TYPE','系统异常','ERROR',6,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('ASSETS_CATALOG_TYPE','数据资产领域','DOMAIN',1,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('ASSETS_CATALOG_TYPE','数据资产主题','TOPIC',2,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('DATA_SOURCE_TYPE','Hive','HIVE',1,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0','');
INSERT INTO honeybee.hb_dict (catalog_name,name,code,dict_order,status,owner,updatetime,createtime,`desc`) VALUES
	 ('DATA_SOURCE_TYPE','MySQL','MYSQL',2,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('DATA_SOURCE_TYPE','MSSQL','MSSQL',3,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('DATA_SOURCE_TYPE','Oracle','ORACLE',4,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('DATA_SOURCE_TYPE','PostgreSQL','POSTGRESQL',5,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('QUALITY_RULE_TYPE','精确性','ACCURACY',1,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('QUALITY_RULE_TYPE','一致性','PROFILING',2,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('QUALITY_RULE_TYPE','唯一性','UNIQUENESS',3,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('QUALITY_RULE_TYPE','有效性','DISTINCT',4,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('QUALITY_RULE_TYPE','及时性','TIMELINESS',5,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0',''),
	 ('QUALITY_RULE_TYPE','完整性','COMPLETENESS',6,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0','');
INSERT INTO honeybee.hb_dict (catalog_name,name,code,dict_order,status,owner,updatetime,createtime,`desc`) VALUES
	 ('MESSAGE_TYPE','系统消息','SYSTEM',1,0,1,'2020-11-01 00:00:00.0','2020-11-01 00:00:00.0','');