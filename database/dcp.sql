...
CREATE DATABASE IF NOT EXISTS dcp;
CREATE USER 'dcp'@'%' IDENTIFIED BY 'dcp';
GRANT ALL ON dcp.* to 'dcp'@'%' WITH GRANT OPTION;
FLUSH PRIVILEGES;

USE dcp;

--
-- Table structure for table `dcp_access_log`
--

DROP TABLE IF EXISTS `dcp_access_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_access_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
  `app_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_app主键ID ，请求用户',
  `dataservice_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_data_service 主键id',
...
--
-- Dumping data for table `dcp_access_log`
--

LOCK TABLES `dcp_access_log` WRITE;
/*!40000 ALTER TABLE `dcp_access_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_access_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_app`
--

DROP TABLE IF EXISTS `dcp_app`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_app` (
...
--
-- Dumping data for table `dcp_app`
--

LOCK TABLES `dcp_app` WRITE;
/*!40000 ALTER TABLE `dcp_app` DISABLE KEYS */;
INSERT INTO `dcp_app` VALUES ('APP_000002','Zhangsan','',6691952877096669184,'enabled','2020-07-23 06:32:36',1,'2020-07-23 06:32:36',NULL),('APP_000003','Lisi','',6691952877096669184,'enabled','2020-07-25 14:04:17',1,'2020-07-25 14:04:17',NULL);
/*!40000 ALTER TABLE `dcp_app` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_app_ds`
--

DROP TABLE IF EXISTS `dcp_app_ds`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_app_ds` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID,自增',
  `app_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_api_user主键ID',
  `dataservice_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_data_service 主键id',
...
--
-- Dumping data for table `dcp_app_ds`
--

LOCK TABLES `dcp_app_ds` WRITE;
/*!40000 ALTER TABLE `dcp_app_ds` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_app_ds` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_app_ds_field`
--

DROP TABLE IF EXISTS `dcp_app_ds_field`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_app_ds_field` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID,自增',
  `app_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_api_user主键ID',
  `dataservice_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_data_service 主键id',
...
--
-- Dumping data for table `dcp_app_ds_field`
--

LOCK TABLES `dcp_app_ds_field` WRITE;
/*!40000 ALTER TABLE `dcp_app_ds_field` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_app_ds_field` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_audit_log`
--

DROP TABLE IF EXISTS `dcp_audit_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_audit_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
--
-- Dumping data for table `dcp_audit_log`
--

LOCK TABLES `dcp_audit_log` WRITE;
/*!40000 ALTER TABLE `dcp_audit_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_audit_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_auth_permission`
--

DROP TABLE IF EXISTS `dcp_auth_permission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_auth_permission` (
...
--
-- Dumping data for table `dcp_auth_permission`
--

LOCK TABLES `dcp_auth_permission` WRITE;
/*!40000 ALTER TABLE `dcp_auth_permission` DISABLE KEYS */;
INSERT INTO `dcp_auth_permission` VALUES (1,1,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,2,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,2,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,2,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,3,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,3,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,3,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,4,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,4,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,4,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,5,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,5,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,5,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,6,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,7,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,7,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,7,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,8,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,8,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,8,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,9,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,10,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,10,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,10,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,11,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,12,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,12,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,12,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,13,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,14,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,15,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,16,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,17,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,18,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,19,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,19,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,19,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,20,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,20,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,20,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,23,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,24,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,27,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,28,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,29,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,30,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,30,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,30,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,31,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(1,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,11,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,12,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,9,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,10,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,10,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,11,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,12,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,12,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,14,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,15,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,29,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,30,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,30,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,31,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,6,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,7,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,7,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,8,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,8,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,9,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,10,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,10,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,11,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,12,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,12,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,21,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,22,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,29,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,30,2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,30,3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,31,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,32,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(4,33,1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1);
/*!40000 ALTER TABLE `dcp_auth_permission` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_auth_resource`
--

DROP TABLE IF EXISTS `dcp_auth_resource`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_auth_resource` (
...
--
-- Dumping data for table `dcp_auth_resource`
--

LOCK TABLES `dcp_auth_resource` WRITE;
/*!40000 ALTER TABLE `dcp_auth_resource` DISABLE KEYS */;
INSERT INTO `dcp_auth_resource` VALUES (1,'permission','安全管理','安全管理','0','1','1',7,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'/permission','security','','',''),(2,'users','平台用户管理','平台用户管理','1','1','2',71,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'users','circle','','',''),(3,'resources','平台资源管理','平台资源管理','1','1','2',73,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'resources','circle','','',''),(4,'roles','平台角色管理','平台角色管理','1','1','2',72,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'roles','circle','','',''),(5,'serviceuser','服务用户管理','服务用户管理','1','1','2',74,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'serviceuser','circle','','',''),(6,'assetmanage','数据资产管理','数据资产管理','0','1','1',2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'/assetmanage','datasource02','','',''),(7,'assetclassifi','资产领域管理','资产领域管理','6','1','2',21,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'assetclassifi','circle','','',''),(8,'assetheme','资产主题管理','资产主题管理','6','1','2',22,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'assetheme','circle','','',''),(9,'serversource','数据源管理','数据源管理','0','1','1',4,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'','asset','','',''),(10,'datasource','数据源管理','数据源管理','9','1','2',NULL,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'datasource','asset','','',''),(11,'serviceapi','数据服务管理','数据服务管理','0','1','1',1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'','service02','','',''),(12,'servicemanage','数据服务管理','数据服务管理','11','1','2',NULL,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'servicemanage','service02','','',''),(13,'operationmoni','运维监控','运维监控','0','1','1',5,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'/operationmoni','monitor','','',''),(14,'statemonitor','数据源监控','数据源监控','13','1','1',NULL,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'statemonitor','circle','','',''),(15,'accessstatic','数据服务监控','数据服务监控','13','1','1',NULL,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'accessstatic','circle','','',''),(16,'logshow','服务访问日志','服务访问日志','13','1','1',NULL,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'logshow','circle','','',''),(17,'platform','平台管理','平台管理','0','1','1',6,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'/platform','setting','','',''),(18,'cloudserver','缓存管理','缓存管理','17','1','1',63,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'cloudserver','circle','','',''),(19,'drivemane','服务驱动管理','服务驱动管理','17','1','2',61,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'drivemane','circle','','',''),(20,'clusteropera','服务运维管理','服务运维管理','17','1','2',62,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'clusteropera','circle','','',''),(21,'test',' 首页','首页','0','1','1',8,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'','','','true',''),(22,'home','首页','首页','21','1','1',NULL,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'home','','','',''),(23,'paramConfig','参数配置','参数配置','0','1','1',9,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'','paramconfig','','',''),(24,'systemparam','系统参数配置','系统参数配置','23','1','1',NULL,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'systemparam','paramconfig','','',''),(27,'clusteraudit','服务审计日志','服务审计日志','13','1','1',0,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'clusteraudit','circle','','',''),(28,'runlog','平台操作日志','平台操作日志','13','1','1',0,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'runlog','circle','','',''),(29,'model','服务模型管理','服务模型管理','0','1','1',3,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'','','','',''),(30,'modelma','服务模型管理','服务模型管理','29','1','2',0,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'modelma','model02','','',''),(31,'assetmap02','数据资产地图','数据资产地图','6','1','1',24,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'dataassetmap','circle','','',''),(32,'messageFirst','消息中心','消息中心','0','1','1',0,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'','','','true',''),(33,'message','消息中心','消息中心','32','1','1',0,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1,'message','','','true','');
/*!40000 ALTER TABLE `dcp_auth_resource` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_auth_resource_category`
--

DROP TABLE IF EXISTS `dcp_auth_resource_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_auth_resource_category` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
...
--
-- Dumping data for table `dcp_auth_resource_category`
--

LOCK TABLES `dcp_auth_resource_category` WRITE;
/*!40000 ALTER TABLE `dcp_auth_resource_category` DISABLE KEYS */;
INSERT INTO `dcp_auth_resource_category` VALUES (1,'menu','菜单','菜单','2020-07-23 05:08:00',1,'2020-07-23 05:08:00',1),(2,'button','按钮','按钮','2020-07-23 05:08:00',1,'2020-07-23 05:08:00',1);
/*!40000 ALTER TABLE `dcp_auth_resource_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_auth_resource_operation`
--

DROP TABLE IF EXISTS `dcp_auth_resource_operation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_auth_resource_operation` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
...
--
-- Dumping data for table `dcp_auth_resource_operation`
--

LOCK TABLES `dcp_auth_resource_operation` WRITE;
/*!40000 ALTER TABLE `dcp_auth_resource_operation` DISABLE KEYS */;
INSERT INTO `dcp_auth_resource_operation` VALUES (1,'access','访问','访问',1,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(2,'access','访问','访问',2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1),(3,'operation','操作','操作',2,'2020-07-23 05:08:01',1,'2020-07-23 05:08:01',1);
/*!40000 ALTER TABLE `dcp_auth_resource_operation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_auth_role`
--

DROP TABLE IF EXISTS `dcp_auth_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_auth_role` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
  `code` varchar(50) DEFAULT NULL COMMENT '操作编号',
...
--
-- Dumping data for table `dcp_auth_role`
--

LOCK TABLES `dcp_auth_role` WRITE;
/*!40000 ALTER TABLE `dcp_auth_role` DISABLE KEYS */;
INSERT INTO `dcp_auth_role` VALUES (1,'administrator','平台管理员','1','','2020-07-23 05:08:00',1,'2020-07-23 05:08:00',1),(2,'data_app','数据应用用户','1','','2020-07-23 05:08:00',1,'2020-07-23 05:08:00',1),(3,'data_engineer','数据工程师','1','','2020-07-23 05:08:00',1,'2020-07-23 05:08:00',1),(4,'data_architect','数据架构师','1','','2020-07-23 05:08:00',1,'2020-07-23 05:08:00',1);
/*!40000 ALTER TABLE `dcp_auth_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_auth_user`
--

DROP TABLE IF EXISTS `dcp_auth_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_auth_user` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
...
--
-- Dumping data for table `dcp_auth_user_role`
--

LOCK TABLES `dcp_auth_user_role` WRITE;
/*!40000 ALTER TABLE `dcp_auth_user_role` DISABLE KEYS */;
INSERT INTO `dcp_auth_user_role` VALUES (1,1,'2020-07-23 05:08:00',1,'2020-07-23 05:08:00',1),(6691952877096669184,2,'2020-07-23 14:31:36',1,NULL,NULL);
/*!40000 ALTER TABLE `dcp_auth_user_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_code`
--

DROP TABLE IF EXISTS `dcp_code`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_code` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
--
-- Dumping data for table `dcp_data_assets_area`
--

LOCK TABLES `dcp_data_assets_area` WRITE;
/*!40000 ALTER TABLE `dcp_data_assets_area` DISABLE KEYS */;
INSERT INTO `dcp_data_assets_area` VALUES ('DMA000006','数据共享','','enabled','dataSharing.png',NULL,NULL,NULL,NULL),('DMA000007','技术平台','','enabled','tecPlatForm.png',NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `dcp_data_assets_area` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_data_assets_topic`
--

DROP TABLE IF EXISTS `dcp_data_assets_topic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_data_assets_topic` (
  `id` varchar(100) NOT NULL COMMENT '主键，数据模型主题ID,格式：DMT+6位数字序列号 如：DMT000001 ',
  `area_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_asset_type主键ID',
...
--
-- Dumping data for table `dcp_data_assets_topic`
--

LOCK TABLES `dcp_data_assets_topic` WRITE;
/*!40000 ALTER TABLE `dcp_data_assets_topic` DISABLE KEYS */;
INSERT INTO `dcp_data_assets_topic` VALUES ('DMT_000002','DMA000006','测试主题','',NULL,'enabled','2020-07-23 05:36:24',1,'2020-07-23 05:36:24',NULL);
/*!40000 ALTER TABLE `dcp_data_assets_topic` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_data_service`
--

DROP TABLE IF EXISTS `dcp_data_service`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_data_service` (
  `id` varchar(100) NOT NULL COMMENT '唯一，api编号,格式：API+6位数字序列号 如：API000001 ',
  `service_model_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_service_model主键ID',
...
--
-- Dumping data for table `dcp_data_service`
--

LOCK TABLES `dcp_data_service` WRITE;
/*!40000 ALTER TABLE `dcp_data_service` DISABLE KEYS */;
INSERT INTO `dcp_data_service` VALUES ('API_000002','DM_000002','asset','deleted','数据共享-测试主题-测试数据模型','read',NULL,'select  order_no, channel2, channel3, dealer, city, store_no, store_name, store_type, customer, phone, sku_name, updatetime, amount, count from trade where 1 = 1  <#if order_no??> and order_no = ${order_no} </#if>  <#if channel2??> and channel2 = ${channel2} </#if> ','POST',NULL,'2020-07-23 06:27:48',1,'2020-08-06 03:50:27',1);
/*!40000 ALTER TABLE `dcp_data_service` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_instance`
--

DROP TABLE IF EXISTS `dcp_instance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_instance` (
...
--
-- Dumping data for table `dcp_instance`
--

LOCK TABLES `dcp_instance` WRITE;
/*!40000 ALTER TABLE `dcp_instance` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_instance` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_instance_resource`
--

DROP TABLE IF EXISTS `dcp_instance_resource`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_instance_resource` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID,自增',
  `instance_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_instance 主键ID',
  `service_source_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_service_source主键ID',
...
--
-- Dumping data for table `dcp_instance_resource`
--

LOCK TABLES `dcp_instance_resource` WRITE;
/*!40000 ALTER TABLE `dcp_instance_resource` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_instance_resource` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_message`
--

DROP TABLE IF EXISTS `dcp_message`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_message` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
--
-- Dumping data for table `dcp_message`
--

LOCK TABLES `dcp_message` WRITE;
/*!40000 ALTER TABLE `dcp_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_message` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_message_object`
--

DROP TABLE IF EXISTS `dcp_message_object`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_message_object` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
--
-- Dumping data for table `dcp_message_object`
--

LOCK TABLES `dcp_message_object` WRITE;
/*!40000 ALTER TABLE `dcp_message_object` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_message_object` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_monitor_kpi_appuser_day`
--

DROP TABLE IF EXISTS `dcp_monitor_kpi_appuser_day`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_monitor_kpi_appuser_day` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
--
-- Dumping data for table `dcp_monitor_kpi_appuser_day`
--

LOCK TABLES `dcp_monitor_kpi_appuser_day` WRITE;
/*!40000 ALTER TABLE `dcp_monitor_kpi_appuser_day` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_monitor_kpi_appuser_day` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_monitor_kpi_appuser_hour`
--

DROP TABLE IF EXISTS `dcp_monitor_kpi_appuser_hour`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_monitor_kpi_appuser_hour` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
--
-- Dumping data for table `dcp_monitor_kpi_appuser_hour`
--

LOCK TABLES `dcp_monitor_kpi_appuser_hour` WRITE;
/*!40000 ALTER TABLE `dcp_monitor_kpi_appuser_hour` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_monitor_kpi_appuser_hour` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_monitor_kpi_dataservice_day`
--

DROP TABLE IF EXISTS `dcp_monitor_kpi_dataservice_day`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_monitor_kpi_dataservice_day` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
  `access_time` varchar(100) DEFAULT NULL COMMENT '访问时间，格式：YYYY-MM-DD',
...
--
-- Dumping data for table `dcp_monitor_kpi_dataservice_day`
--

LOCK TABLES `dcp_monitor_kpi_dataservice_day` WRITE;
/*!40000 ALTER TABLE `dcp_monitor_kpi_dataservice_day` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_monitor_kpi_dataservice_day` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_monitor_kpi_dataservice_hour`
--

DROP TABLE IF EXISTS `dcp_monitor_kpi_dataservice_hour`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_monitor_kpi_dataservice_hour` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
  `access_time` varchar(100) DEFAULT NULL COMMENT '访问时间，格式：YYYY-MM-DD HH24',
  `dataservice_id` varchar(100) DEFAULT NULL COMMENT '服务ID',
  `status_code` varchar(100) DEFAULT NULL COMMENT '执行状态，成功/失败',
...
--
-- Dumping data for table `dcp_monitor_kpi_dataservice_hour`
--

LOCK TABLES `dcp_monitor_kpi_dataservice_hour` WRITE;
/*!40000 ALTER TABLE `dcp_monitor_kpi_dataservice_hour` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_monitor_kpi_dataservice_hour` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_parameter`
--

DROP TABLE IF EXISTS `dcp_parameter`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_parameter` (
...
--
-- Dumping data for table `dcp_parameter`
--

LOCK TABLES `dcp_parameter` WRITE;
/*!40000 ALTER TABLE `dcp_parameter` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_parameter` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_service_driver`
--

DROP TABLE IF EXISTS `dcp_service_driver`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_service_driver` (
...
--
-- Dumping data for table `dcp_service_driver`
--

LOCK TABLES `dcp_service_driver` WRITE;
/*!40000 ALTER TABLE `dcp_service_driver` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_service_driver` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_service_model`
--

DROP TABLE IF EXISTS `dcp_service_model`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_service_model` (
  ...
  `topic_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_data_model_topic主键ID',
  `service_source_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_service_source主键ID',
...
--
-- Dumping data for table `dcp_service_model`
--

LOCK TABLES `dcp_service_model` WRITE;
/*!40000 ALTER TABLE `dcp_service_model` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_service_model` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_service_model_field`
--

DROP TABLE IF EXISTS `dcp_service_model_field`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_service_model_field` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID,自增',
  `service_model_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_service_model主键ID',
...
--
-- Dumping data for table `dcp_service_model_field`
--

LOCK TABLES `dcp_service_model_field` WRITE;
/*!40000 ALTER TABLE `dcp_service_model_field` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_service_model_field` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_service_model_param`
--

DROP TABLE IF EXISTS `dcp_service_model_param`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_service_model_param` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID,自增',
  `service_model_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_service_model主键ID',
  `seq_num` int(11) DEFAULT NULL COMMENT '数字序列，datamodel_id+seq_num唯一',
...
--
-- Dumping data for table `dcp_service_model_param`
--

LOCK TABLES `dcp_service_model_param` WRITE;
/*!40000 ALTER TABLE `dcp_service_model_param` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_service_model_param` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_service_source`
--

DROP TABLE IF EXISTS `dcp_service_source`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_service_source` (
  `id` varchar(100) NOT NULL COMMENT '主键，数据源ID,格式：DTS+6位数字序列号，如：DTS000001',
  `driver_id` varchar(100) DEFAULT NULL COMMENT '关联dcp_driver的主键ID',
...
--
-- Dumping data for table `dcp_service_source`
--

LOCK TABLES `dcp_service_source` WRITE;
/*!40000 ALTER TABLE `dcp_service_source` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_service_source` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_sys_audit_log`
--

DROP TABLE IF EXISTS `dcp_sys_audit_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_sys_audit_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
--
-- Dumping data for table `dcp_sys_audit_log`
--

LOCK TABLES `dcp_sys_audit_log` WRITE;
/*!40000 ALTER TABLE `dcp_sys_audit_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_sys_audit_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_sys_config`
--

DROP TABLE IF EXISTS `dcp_sys_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_sys_config` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
--
-- Dumping data for table `dcp_sys_config`
--

LOCK TABLES `dcp_sys_config` WRITE;
/*!40000 ALTER TABLE `dcp_sys_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `dcp_sys_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dcp_sys_sequence`
--

DROP TABLE IF EXISTS `dcp_sys_sequence`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dcp_sys_sequence` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
...
--
-- Dumping data for table `dcp_sys_sequence`
--

LOCK TABLES `dcp_sys_sequence` WRITE;
/*!40000 ALTER TABLE `dcp_sys_sequence` DISABLE KEYS */;
INSERT INTO `dcp_sys_sequence` VALUES (1,'SEQ_EXAMPLE','EG_','序列测试',6,1,1,'2020-07-23 05:08:02',1,'2020-07-23 05:08:02',1),(2,'dcp_service_source','DTS_','数据源',6,3,1,'2020-07-23 05:08:02',1,'2020-07-23 05:08:02',1),(3,'dcp_data_service','API_','数据服务',6,2,1,'2020-07-23 05:08:02',1,'2020-07-23 05:08:02',1),(4,'app_user','APP_','应用用户',6,3,1,'2020-07-23 05:08:02',1,'2020-07-23 05:08:02',1),(5,'dcp_data_assets_area','DMA_','资产领域',6,1,1,'2020-07-23 05:08:02',1,'2020-07-23 05:08:02',1),(6,'dcp_data_assets_topic','DMT_','资产主题',6,2,1,'2020-07-23 05:08:02',1,'2020-07-23 05:08:02',1),(7,'dcp_service_model','DM_','资产模型',6,2,1,'2020-07-23 05:08:02',1,'2020-07-23 05:08:02',1),(8,'dcp_service_driver','DRI_','数据驱动',6,2,1,'2020-07-23 05:08:02',1,'2020-07-23 05:08:02',1),(9,'instance','INS_','集群实例',6,9,1,'2020-07-23 05:08:02',1,'2020-07-23 05:08:02',1);
/*!40000 ALTER TABLE `dcp_sys_sequence` ENABLE KEYS */;
UNLOCK TABLES;
...
BEGIN
    ...
    SET VALUE = '0';
    SELECT CONCAT(seq_prefix, LPAD(last_use_seq, seq_digit, '0')) INTO VALUE FROM dcp_sys_sequence WHERE table_name = v_seq_name;
		RETURN VALUE;
END$$
...
BEGIN
    UPDATE dcp_sys_sequence SET last_use_seq = last_use_seq + seq_increment  WHERE table_name = v_seq_name;
...
BEGIN
      DELETE FROM dcp_access_log WHERE create_time<DATE_ADD(CURDATE() ,INTERVAL -s DAY);
END$$
DELIMITER ;
