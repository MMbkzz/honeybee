...
public class AccessLogInfo {
    ...
    public int getFreeResourceNum() {
        return freeResourceNum;
    }

    public void setFreeResourceNum(int freeResourceNum) {
        this.freeResourceNum = freeResourceNum;
    }
