...
import static com.stackstech.honeybee.server.bees.exception.BeesExceptionMessage.QUARTZ_JOB_ALREADY_EXIST;
import static com.stackstech.honeybee.server.bees.service.impl.JobServiceImpl.GRIFFIN_JOB_ID;
...
public class JobInstance implements Job {
    ...
    private void createJobInstance(Map<String, Object> confMap)
        ...
        if (factory.getScheduler().checkExists(tk)) {
            throw new BeesException.ConflictException(QUARTZ_JOB_ALREADY_EXIST);
        }
    ...
    private void saveJobInstance(String pName, String pGroup, String triggerKey) {
        HoneyBees.ProcessType type = measure.getProcessType() == BATCH ? BATCH :
                STREAMING;
