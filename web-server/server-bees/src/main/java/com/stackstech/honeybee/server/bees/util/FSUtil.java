...
import static com.stackstech.honeybee.server.bees.exception.BeesExceptionMessage.HDFS_FILE_NOT_EXIST;
...
public class FSUtil {
    ...
    public static InputStream getSampleInputStream(String path)
        ...
        if (isFileExist(path)) {
            ...
            throw new BeesException.NotFoundException(HDFS_FILE_NOT_EXIST);
        }
    }
