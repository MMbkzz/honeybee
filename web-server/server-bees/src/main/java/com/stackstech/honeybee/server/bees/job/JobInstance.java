...
import static com.stackstech.honeybee.server.bees.entity.GriffinMeasure.ProcessType.STREAMING;
import static com.stackstech.honeybee.server.bees.entity.LivySessionStates.State.FINDING;
import static com.stackstech.honeybee.server.bees.exception.GriffinExceptionMessage.QUARTZ_JOB_ALREADY_EXIST;
import static com.stackstech.honeybee.server.bees.job.JobServiceImpl.GRIFFIN_JOB_ID;
import static com.stackstech.honeybee.server.bees.util.JsonUtil.toEntity;
import static com.stackstech.honeybee.server.bees.util.JsonUtil.toJson;
...
public class JobInstance implements Job {
    ...
    private void saveJobInstance(String pName, String pGroup, String triggerKey) {
        GriffinMeasure.ProcessType type = measure.getProcessType() == BATCH ? BATCH :
                STREAMING;
