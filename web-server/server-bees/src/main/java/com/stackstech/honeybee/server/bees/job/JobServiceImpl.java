...
import com.stackstech.honeybee.server.bees.event.GriffinEventManager;
...
public class JobServiceImpl implements JobService {
    ...
    private JobOperator getJobOperator(GriffinMeasure.ProcessType type) {
        if (type == BATCH) {
            return batchJobOp;
    ...
    void addJob(TriggerKey tk, AbstractJob job, GriffinMeasure.ProcessType type) throws
            Exception {
    ...
    private Trigger genTriggerInstance(TriggerKey tk, JobDetail jd, AbstractJob
            job, GriffinMeasure.ProcessType type) {
