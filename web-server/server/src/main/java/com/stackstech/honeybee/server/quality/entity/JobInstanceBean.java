...
public class JobInstanceBean extends AbstractAuditableEntity {
    ...
    @Enumerated(EnumType.STRING)
    private HoneyBees.ProcessType type = BATCH;
    ...
    public HoneyBees.ProcessType getType() {
        return type;
    }

    public void setType(HoneyBees.ProcessType type) {
        this.type = type;
    }
    ...
    public JobInstanceBean(LivySessionStates.State state, String pName, String pGroup, Long tms,
                           Long expireTms, HoneyBees.ProcessType type) {
        this(state, pName, pGroup, tms, expireTms);
        this.type = type;
    }
