...
public class MySQLConnector extends AbstractBasicDataSourceConnector implements ResourceSession {
    ...
    private MySQLConnector(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public static MySQLConnector getInstance(ClassLoader classLoader) {
        return new MySQLConnector(classLoader);
    }
     ...
     */
    public MySQLConnector initialize(Map<String, Object> config) {
