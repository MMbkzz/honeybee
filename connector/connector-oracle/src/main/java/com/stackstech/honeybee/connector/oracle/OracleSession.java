...
public class OracleSession extends AbstractBasicDataSourceSession implements ResourceSession {

    private JdbcTemplate jdbcTemplate;

    private OracleSession(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public static OracleSession getInstance(ClassLoader classLoader) {
        return new OracleSession(classLoader);
    }

    public OracleSession initialize(Map<String, Object> config) {
