...
PROC_TAG="honeybee-cloud-gateway"
#-----------------------------------------------------------------------
...
#-----------------------------------------------------------------------
# Process log file
LOG_FILE="$SERVER_DIR/log/honeybee-cloud-gateway.out"
#-----------------------------------------------------------------------
...
MAIN_CLASS="com.stackstech.honeybee.gateway.HoneybeeGatewayApplication"
#-----------------------------------------------------------------------
