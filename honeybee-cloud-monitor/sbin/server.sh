...
PROC_TAG="honeybee-cloud-monitor"
#-----------------------------------------------------------------------
...
#-----------------------------------------------------------------------
# Process log file
LOG_FILE="$SERVER_DIR/log/honeybee-cloud-monitor.out"
#-----------------------------------------------------------------------
...
MAIN_CLASS="com.stackstech.honeybee.monitor.HoneybeeMonitorApplication"
#-----------------------------------------------------------------------
